...
Revision ID: 92916bfa6f6c
Revises: 
Create Date: 2024-09-10 03:21:37.250053
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['blog_id'], ['blogs.id'], name=op.f('comments_blog_id_fkey'), ondelete='CASCADE'),
